...
# fct_relevel() function in forcats, lets you set whatever level you want
...
# this way you can reset which level R uses as the reference level
...
full_aic <- AIC(homes_lm1) # 10699.25
final_aic<- AIC(homes_lm3) # 11148

# would pick the full_aic if you only looked at the first model, but remember if you look at everything else doesn't make sense to pick the first model at all
